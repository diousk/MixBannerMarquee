...
public abstract class LoopPagerAdapter extends PagerAdapter {
    private LRollPagerView mViewPager;

    private ArrayList<View> mViewList = new ArrayList<>();

    private class LoopHintViewDelegate implements LRollPagerView.HintViewDelegate {
        @Override
    ...
    public LoopPagerAdapter(LRollPagerView viewPager) {
